...
VALUES (NEXTVAL('region_id_seq'), 'Вінницька область', (SELECT id from country where iso_alpha3code = 'UKR')),
...
-- subregion
INSERT INTO region (id, name, country_id, parent_region_id)
VALUES (NEXTVAL('region_id_seq'), 'Кагарлицький район', (SELECT id from country where iso_alpha3code = 'UKR'), (SELECT id from region where name = 'Київська область')),
